...
<table>
  <tr>
   ...
   <table width="413">
	...
	<a href="<%=request.getContextPath()%>/noticeUpdate.do?idx=<%=noticeVo.getNotice_id() %>"><input type=button value="수정"></a>
	<a href="<%=request.getContextPath()%>/noticeDelete.do?idx=<%=noticeVo.getNotice_id() %>"><input type=button value="삭제"></a>
      <td width="0">&nbsp;</td>
     </tr>
    </table>
   </td>
