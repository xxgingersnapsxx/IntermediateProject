...
public class MemberVO {
	...
	public MemberVO(String memJoin, String memRej, String memberId, int cityCode, String memberPw, String memberNm,
			String memberBir, String membmerMail, String memberHp, String memberGen, String memberImg1,
			String memberImg2, String memberHobby, String profileIntro, String memberInsta, String profileMusic,
			String matchType) {
		super();
	...
	public MemberVO(String memJoin, String memRej, String memberId, int cityCode, String memberPw, String memberNm,
			String memberBir, String membmerMail, String memberHp, String memberGen, String memberImg1,
			String memberImg2, String memberHobby, String profileIntro, String memberInsta, String profileMusic,
			String matchType, String approveNy, String memberDrop, String membershipYn) {
		super();
		this.memJoin = memJoin;
		this.memRej = memRej;
		this.memberId = memberId;
	...
	public String getMemberDrop() {
		return memberDrop;
	}

	public void setMemberDrop(String memberDrop) {
		this.memberDrop = memberDrop;
	}
