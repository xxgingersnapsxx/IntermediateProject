...
public class CryptoUtil {
	...
	public static String encryptAES256(String str, String key)
		...
		// 초기화 벡터(Initial Vector, IV) - 암호문이 패턴화 되지 않도록 사용 하는 데이터
		...
		// 암호문 생성
		byte[] encrpted = c.doFinal(str.getBytes("UTF-8"));

		return Base64.getEncoder().encodeToString(encrpted);
	}
	...
	public static String decryptAES256(String str, String key)
		...
		byte[] byteStr = Base64.getDecoder().decode(str); // 암호문을 decoding
